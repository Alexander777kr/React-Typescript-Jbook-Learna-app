...
var local_api_1 = require("@al777/local-api");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, local_api_1.serve)(parseInt(options.port, 10), path_1.default.basename(filename), dir, !isProduction)];
                case 1:
                    _a.sent();
                ...
                case 2:
                    ...
                    if (err_1.code === 'EADDRINUSE') {
                        ...
                        console.log('Here\'s the problem', err_1.message);
                    }
                    process.exit(1);
                    return [3 /*break*/, 3];
